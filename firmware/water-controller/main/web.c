...
//static esp_err_t test_token_handler(httpd_req_t *req) {
//    if (!auth(req)) {
//        return doAuth(req);
//    }
//    int length = req->content_len;
...
//        return ESP_FAIL;
//    }
//    char *token = get_token(GCP_SEND_METRICS_URL);
//
//    ESP_LOGI(TAG, "ID token len: %d", strlen(token));
//
//    return httpd_resp_send(req, token, strlen(token));
//}

//static esp_err_t test_get_method_handler(httpd_req_t *req) {
//    if (!auth(req)) {
//        return doAuth(req);
//    }
//    int length = req->content_len;
...
//        return ESP_FAIL;
//    }
//    char *output = get(GCP_SEND_METRICS_URL);
//    return httpd_resp_send(req, output, strlen(output));
//}
...
static esp_err_t test_send_metrics_handler(httpd_req_t *req) {
    send_metrics(0, time(NULL), time(NULL) + 1);
    return httpd_resp_send(req, "", strlen(""));
}
...
void httpd(int port) {
    ...
    httpd_uri_t test_send_metrics_uri = {
            .uri = "/test-send-metrics",
            .method = HTTP_GET,
            .handler = test_send_metrics_handler,
            .user_ctx = NULL};

    //    httpd_uri_t token_uri = {
//            .uri = "/token",
//            .method = HTTP_POST,
//            .handler = test_token_handler,
//            .user_ctx = NULL};
//
//    httpd_uri_t get_uri = {
//            .uri = "/get",
//            .method = HTTP_POST,
//            .handler = test_get_method_handler,
//            .user_ctx = NULL};
